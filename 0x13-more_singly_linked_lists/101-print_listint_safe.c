/* A program for file 101-print_listint_safe.c */
...
/**
 * check_looped_listint - this always checks if there is loop in a linked list,
...
size_t check_looped_listint(const listint_t *head)
{
	...
	if (tortoise == hare) /* this is a count unique node in a looped list */
	{
		tortoise = head;
		while (tortoise != hare)
		{
...
/**
 * print_listint_safe - this will always print a listint_t list safely.
 * @head: this is a pointer to the head of the listint_t list.
 *
 * Return: This will Always return the number of nodes in the list.
 */
size_t print_listint_safe(const listint_t *head)
{
	...
	return (nodes); /* This will end the program */
}
